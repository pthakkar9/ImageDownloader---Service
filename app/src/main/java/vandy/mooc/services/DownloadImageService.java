...
public class DownloadImageService extends IntentService {
    ...
    public static Intent makeIntent(Context context,
        ...
        baseIntent.putExtra(MESSENGER,
                new Messenger(downloadHandler));
        baseIntent.putExtra(DIRECTORY_PATHNAME, directoryPathname);
//        baseIntent.putExtra(IMAGE_URL, url.toString());
        baseIntent.putExtra(REQUEST_CODE, requestCode);
        return baseIntent;
...
//        String pathname = getImagePathname(intent.getExtras());
        ...
        // @@ TODO -- you fill in here.
        Uri imagePathname = Utils.downloadImage(DownloadImageService.this, url, dirPathname);
        ...
        // @@ TODO -- you fill in here.
        sendPath(messenger, imagePathname, url);
    ...
    private void sendPath(Messenger messenger,
        ...
        try {
            ...
            Log.e(TAG, "Could not send pathname back to MainActivity", e);
        }
    }
    ...
    private Message makeReplyMessage(Uri pathToImageFile,
        ...
        // IMAGE_URL key.
        // @@ TODO -- you fill in here.
        replyBundle.putString(IMAGE_URL, url.toString());
        ...
        if (message.arg1 == Activity.RESULT_OK) {
            replyBundle.putString(IMAGE_PATHNAME, pathToImageFile.toString());
        }
